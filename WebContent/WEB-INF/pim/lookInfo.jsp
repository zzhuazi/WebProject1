...
<html>
	<head>
		...
		<style type="text/css">
			...
			section.container section div.address, section.container div.tip{
				margin-top: 50px;
			    background: #fff;
				border: 1px solid #dbd9e1;;
			}
			section.container div.tip{
				line-height: 40px;
				padding-left: 20px;
			}
				...
				<div class="address">
					<div class="address-one">
						<div class="name">
							...
							<s:textfield value="%{#request.info.name }" id="name" readonly="true"/>
						</div>
						<div class="phone">
							<label for="phone">余额</label>
							<s:textfield value="%{#request.info.balance }" type="tel" id="phone" readonly="true"/>
						</div>
					</div>
					<div class="detail-address">
						<label for="deAddress">账号邮箱</label>
						<s:textfield value="%{#request.info.email }" id="deAddress" readonly="true" />
					</div>
				</div>
			</section>
			<div style="clear: both;"></div>
