	...
	<body>
		...
		<section class="container">
			...
			<section>
				...
				<div class="address">
					<s:form action="userAddAddress">
						<s:token></s:token>
						<div class="address-one">
							<div class="name">
								<label for="name">姓名</label>
								<s:textfield name="userVo.address.name" id="name"/>
							</div>
							<div class="phone">
								<label for="phone">电话</label>
								<s:textfield name="userVo.address.phone" type="tel" id="phone"/>
							</div>
						</div>
						<div class="detail-address">
							<label for="deAddress">详细地址</label>
							<s:textfield name="userVo.address.address" id="deAddress" />
						</div>
						<div class="detail-address">
							<label for="">设置问默认收货地址</label>
							<s:select list="#{'1':'默认收货地址','0':'非默认收货地址' }" name="userVo.address.priority"></s:select>
						</div>
						<div class="sub">
							<div>
