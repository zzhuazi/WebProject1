...
<html>
	<head>
		...
		<style type="text/css">
			...
			section.container div.address div.address-one label, 	section.container div.address div.address-one input{
				display: block;
			}
	...
	<body>
		...
		<section class="container">
			...
			<section>
				...
				<div class="address">
					<s:form action="userUpdateAddress">
						<s:token></s:token>
						<s:hidden name="address.id" value="%{#request.address.id}"></s:hidden>
						<div class="address-one">
							<div class="name">
								<label for="name">姓名</label>
								<s:textfield id="name" name="address.name" value="%{#request.address.name}"/>
							</div>
							<div class="phone">
								<label for="phone">电话</label>
								<s:textfield name="address.phone" value="%{#request.address.phone}"  type="tel" id="phone"/>
							</div>
						</div>
						<div class="detail-address">
							<label for="deAddress">详细地址</label>
							<s:textfield name="address.address" value="%{#request.address.address}" id="deAddress"/>
						</div>
						<s:hidden name="address.priority" value="%{#request.address.priority}"></s:hidden>
						<div class="sub">
							<div>
