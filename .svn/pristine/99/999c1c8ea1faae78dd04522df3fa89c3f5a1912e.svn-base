					...
					<div>
						...
						<div class="option hidden">
							<ul>
								...
								<li><a href="../userToUpdateInfo">个人信息管理</a></li>
					...
					<s:form action="">
						...
						<div class="table-body">
							<table>
								...
								<s:iterator value="#request.cartOrders" var="cartOrders" >
									...
									<tr>
										...
										<td class="td-5">
											<a href="winpUpCart?oid=${id }">结算</a>
											<a href="deleteCartOrders?oid=${id }">删除</a>
										</td>
									</tr>
									</s:iterator>
								</tbody>
